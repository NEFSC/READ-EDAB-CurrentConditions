# extract by lat lon range

library(ncdf4)
## nes_std_area_v5.xlsx
## Computational fields in the .xlsx (region == NES regions [2 and 3] and locals classify what region we're in (the 2 degree squares that constitute the NES))
# all year
years="ersst"
...
setwd("d:/2_two/2_ersst/datafiles_v5")


# NES standard bounded by 34-46N and 78-62W
minlon= -78; maxlon= -62; minlat= 34; maxlat= 46
dataoutfile="d:/2_two/2_ersst/nes_std_area_v5.csv"
...
# Conne R Lab
#minlon= -58; maxlon= -54; minlat= 46; maxlat= 48
#dataoutfile="d:/2_two/2_ersst/nes_conne_r_v5.csv"
